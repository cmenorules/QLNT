...
namespace QuanLyNhaTre.GUI.QuanLyBaoCao
{
    public partial class XemBaoCao : Form
    {
        ...
        private void XemBaoCao_Load(object sender, EventArgs e)
        {
            ...
            cReportOverall.Load(@"D:\Study\2014-2015\hk2\Phân tích thiết kế hệ thống\Phần mềm quản lý nhà trẻ\trunk\QuanLyNhaTre\QuanLyNhaTre\GUI\QuanLyBaoCao\CrystalReportOverall.rpt");
